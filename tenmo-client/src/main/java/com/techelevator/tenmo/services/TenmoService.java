...
public class TenmoService {
    ...
    //Rest method to get account balance request through exchange rate api
    ...
    // connects the endpoints to list all users to authenticated logged in user
   ...
   // allows transfer requests with entered userIds
